...
urlpatterns = [
    ...
    # path('mushroom_bags/', views.mushroom_bags, name='mushroom_bags'),
    # path('edit_mushroom_bag/', views.edit_mushroom_bag, name='edit_mushroom_bag'),
    # path('delete_mushroom_bag/', views.delete_mushroom_bag, name='delete_mushroom_bag'),
